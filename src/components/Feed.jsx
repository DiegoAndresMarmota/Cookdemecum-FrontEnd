          ...
          <div className="md:flex">
              ...
              <div class="flex justify-between items-center m-8">
                <div className="flex flex-row items-center">
                  <div className="flex flex-row items-center ml-2">
                    <img src="" class="rounded-full" width="40" />
                    <span className="font-bold mr-1 ml-2"></span>
            ...
            <div class="p-4 flex justify-between items-center">
              <div class="flex flex-row items-center ">
                ...
                <p className="mb-2 pl-2 text-xs font-semibold tracking-wide text-gray-600 uppercase"></p>
              </div>
            </div>
          </div>
        </div>
