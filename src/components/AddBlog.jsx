                  ...
                  <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        id="title"
                        className="bg-white w-full border border-slate-300 rounded-md py-2 pl-3 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"
